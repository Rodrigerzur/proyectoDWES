                ...
                <div class="header_content d-flex flex-row align-items-center justify-content-start">
                    ...
                    <nav class="main_nav">
                        <ul class="d-flex flex-row align-items-start justify-content-start">
                            ...
                            <li class="active"><a href="indexProyectoDWES.php">DWES</a></li>
                            <li><a href="">DIW</a></li>
                            <li><a href="">DWEC</a></li>
                            <li><a href="">EIE</a></li>
                            <li><a href="">DAW</a></li>
                ...
                <div class="menu_log_reg">
                    <nav class="menu_nav">
                        <ul>
                            ...
                            <li><a href="indexProyectoDWES.php">DWES</a></li>
                            <li><a href="">DIW</a></li>
                            <li><a href="">DWEC</a></li>
                            <li><a href="">EIE</a></li>
                            <li><a href="">DAW</a></li>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="section_title_container text-center">
                                <div class="section_subtitle">TEMAS DE</div>
                                <div class="section_title"><h1>DWES</h1></div>
                            </div>
                        </div>
                    </div>
